...
TV_COLUMNS = [
    ...
    "total_revenue_forecast_next_fq",
    "total_revenue_forecast_next_fy",
    "gross_margin",
    "operating_margin",
    "net_margin",
...
def _standardize(row: dict[str, Any], country: str, run_date: date, signal: str) -> dict[str, Any]:
    ...
    item = {
        ...
        "forward_eps": to_float(row.get("earnings_per_share_forecast_next_fy")) or to_float(row.get("earnings_per_share_forecast_next_fq")),
        "eps_growth_yoy": to_float(row.get("earnings_per_share_diluted_yoy_growth_ttm")),
        "eps_growth_qoq": to_float(row.get("earnings_per_share_diluted_qoq_growth_fq")),
        "total_revenue": total_revenue,
        "expected_revenue": to_float(row.get("total_revenue_forecast_next_fy")) or to_float(row.get("total_revenue_forecast_next_fq")),
        "revenue_growth_yoy": to_float(row.get("total_revenue_yoy_growth_ttm")),
        "revenue_growth_qoq": to_float(row.get("total_revenue_qoq_growth_fq")),
        ...
        "roic": to_float(row.get("return_on_invested_capital")) or to_float(row.get("return_on_invested_capital_fq")),
